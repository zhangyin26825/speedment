package com.zhangyin.speedment.speedment.db0.sakila.staff;

import com.zhangyin.speedment.speedment.db0.sakila.staff.generated.GeneratedStaff;

/**
 * An interface representing an entity (for example, a row) in the Table
 * speedment.db0.sakila.staff.
 * <p>
